...
(function (root, factory) {
  ...
  function _introForElement(targetElm) {
    ...
    if(_addOverlayLayer.call(self, targetElm)) {
      ...
      var skipButton = targetElm.querySelector('.icon .icon-close'),
          nextStepButton = targetElm.querySelector('.btn-next');
  ...
  function _showElement(targetElement) {
    ...
    if(oldHelperLayer != null) {
      var oldHelperNumberLayer = oldHelperLayer.querySelector('.introjs-helperNumberLayer'),
          ...
          skipTooltipButton    = oldHelperLayer.querySelector('.icon-close'),
          prevTooltipButton    = oldHelperLayer.querySelector('.btn-prev'),
          nextTooltipButton    = oldHelperLayer.querySelector('.btn-next');
      ...
      self._lastShowElementTimer = setTimeout(function() {
        ...
        oldtooltipLayer.innerHTML = '<strong class="introjs-tooltiptitle">' +
									targetElement.title +
									'</strong>' +
									targetElement.intro;
      ...
      tooltipLayer.className = 'introjs-tooltip mic';

      
      tooltipLayer.innerHTML = '<div class="introjs-tooltiptext">' +
		  					   '<strong class="introjs-tooltiptitle">' +
		  					   targetElement.title +
							   '</strong>' +
                               targetElement.intro +
      ...
      nextTooltipButton.onclick = function() {
        ...
        if(self._introItems.length - 1 != self._currentStep) {
          _nextStep.call(self);
        } else if (typeof (self._introExitCallback) === 'function') {
			self._introExitCallback.call(self);
      ...
      skipTooltipButton.className = 'icon icon-close ir';
    ...
    if (this._currentStep == 0) {
      prevTooltipButton.className = 'btn btn-nav btn-prev btn-hidden';
      nextTooltipButton.className = 'btn btn-nav btn-next';
      skipTooltipButton.innerHTML = this._options.skipLabel;
    } else if (this._introItems.length - 1 == this._currentStep) {
      skipTooltipButton.innerHTML = this._options.doneLabel;
      prevTooltipButton.className = 'btn btn-nav btn-prev';
